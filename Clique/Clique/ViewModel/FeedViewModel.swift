...
class FeedViewModel: ObservableObject {
    ...
    @Published var usernamesById: [String: String] = [:]   // cache: userID → username
        ...
        func fetchPosts() async {
            // 1) ensure we have group IDs
            let groupIds = userVM.groupIds
            ...
            do {
                ...
                let loaded = snap.documents.map { doc in
                    ...
                    return Post(
                        ...
                        groupID:  d["groupID"] as? String ?? "",       // ← pull groupID
        ...
        private func fetchUsernames(for userIDs: [String]) async {
            for uid in userIDs {
                ...
                do {
                    ...
                    print("⚠️ failed fetching username for \(uid):", error)
